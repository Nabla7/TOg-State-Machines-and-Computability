...
file_path_no_noise = 'nonoise_(0{2}1{2}){2,3}.csv'
file_path_noise = 'nonoise_(0{2}1{2}){2,3}.csv'
...
axs[0, 0].set_title('Average Accuracy - Shallow RNN (No Noise) for (0{2}1{2}){2,3}')
axs[0, 0].set_xlabel('Hidden Size')
axs[0, 0].set_ylabel('Sequence Length')

# Accuracy with noise
sns.heatmap(avg_accuracy_noise, ax=axs[0, 1], cmap='viridis')
axs[0, 1].set_title('Average Accuracy - Shallow RNN (With Noise) for (0{2}1{2}){2,3}')
...
axs[1, 0].set_title('Mean Loss - Shallow RNN (No Noise) for (0{2}1{2}){2,3}')
...
axs[1, 1].set_title('Mean Loss - Shallow RNN (With Noise) for (0{2}1{2}){2,3}')
axs[1, 1].set_xlabel('Hidden Size')
axs[1, 1].set_ylabel('Sequence Length')

plt.savefig('(0{2}1{2}){2,3}.png')
plt.tight_layout()
plt.show()
