...
file_path_no_noise = '(00|11)*.csv'
file_path_noise = '(00|11)*.csv'
...
axs[1, 0].set_title('Mean Loss - Shallow RNN (00|11)*')
...
axs[1, 1].set_title('Mean Loss - Shallow RNN (00|11)*')
axs[1, 1].set_xlabel('Hidden Size')
axs[1, 1].set_ylabel('Sequence Length')

plt.savefig('(00|11)*.png')
plt.tight_layout()
plt.show()
